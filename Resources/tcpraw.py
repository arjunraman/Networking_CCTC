...
ip_ver_ihl =
# This combines the DSCP and ECN fields.  Type of service/QoS
ip_tos =
...
ip_ttl =
# This sets the IP protocol to 6 (TCP) or 11 (UDP) (reference IANA)
ip_proto =
...
# Byte Order: https://docs.python.org/3/library/struct.html#byte-order-size-and-alignment
# Character Formats: https://docs.python.org/3/library/struct.html#format-characters
...
tcp_seq =
# tcp ack sequence number. 1-4294967295
tcp_ack_seq =
